...
Feature: Assert the vehicle details
  ...
  Scenario: Assert the Vehicle model for given vehicle registration number
    ...
    And user enters valid registration number from excel with row 1 and column 5
    When user selects continue to confirm
    Then user should be able to verify the vehicle model as in row 1 column 1
  ...
  Scenario: Assert the vehicle colour for given registration number
    ...
    And user enters valid registration number from excel with row 1 and column 5
    When user selects continue to confirm
    Then assert the vehicle colour to be as in row 1 coloumn 2
